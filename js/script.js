     ...
     console.log(chosenCategoryShortName);
      ...
      $ajaxUtils.sendGetRequest(
            ...
            function (responseText) {
              document.querySelector("#main-content")
              .innerHTML = responseText;   
              homeHtmlToInsertIntoMainPage = responseText;    
...
dc.loadMenuCategories = function () {
   console.log('loadMenuCategories');
  showLoading("#main-content");
  $ajaxUtils.sendGetRequest(
    allCategoriesUrl,
...
function buildCategoriesViewHtml(categories,
                                 categoriesTitleHtml,
                                 categoryHtml) {
  console.log('buildCategoriesViewHtml ' + categories + ' ' + categoriesTitleHtml + ' ' + categoryHtml);
  ...
  console.log('Returning final html : ' + finalHtml)
}
...
function buildAndShowMenuItemsHTML (categoryMenuItems) {
   console.log('buildAndShowMenuItemsHTML ' + categoryMenuItems);
